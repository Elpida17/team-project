...
@Query(
       ...
       "WHERE (:type IS NULL OR LOWER(p.type) LIKE LOWER(CONCAT('%', :type, '%'))) " + //ο χρήστης μπορεί να βρεί το προϊόν ακόμη και αν δεν το γράψει ακριβώς όπως πρέπει(π.χ.Lap αντί για Laptop)
